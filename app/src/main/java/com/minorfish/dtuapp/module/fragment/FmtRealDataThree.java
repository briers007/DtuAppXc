 ...
 * Date: 2018/7/11
 */
public class FmtRealDataThree extends BaseFragment {
    ...
    final List<RealDataBean> rvData3 = new ArrayList<>();
    ...
    volatile HashMap<DeviceMonitorEnum, TriggerBean> mData3 = new HashMap<>();
    ...
    public static FmtRealDataThree newInstance(int type) {
        FmtRealDataThree fragment = new FmtRealDataThree();
    ...
    protected View setContentView(LayoutInflater inflater, @Nullable ViewGroup container) {
        return inflater.inflate(R.layout.fmt_real_data_three_layout, container, false);
    }
    ...
    protected void initView() {
        ...
        //if(type == 0) {
            height1 = Utils.dip2px(getActivity(), 200);
            height2 = Utils.dip2px(getActivity(), 125);
            rvRealData.setHeight(height1);
//        }else{
//            height2 = Utils.dip2px(getActivity(), 94);
//            rvRealData.setHeight(height1);
//        }
    ...
    public synchronized void showData(HashMap<DeviceMonitorEnum, TriggerBean> data, final int type) {
        ...
        try {
            if (type == 0) {
                ...
                mData3.putAll(data);
                rvData3.clear();
                for (Map.Entry<DeviceMonitorEnum, TriggerBean> item : mData3.entrySet()) {
                    TriggerBean triggerBean = item.getValue();
                    RealDataBean bean = new RealDataBean();
                    bean.mTitle = item.getKey().getValue();
                    bean.mUnit = item.getKey().getUnit();
