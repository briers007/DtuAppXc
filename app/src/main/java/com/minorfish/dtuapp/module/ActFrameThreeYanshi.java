...
//import com.minorfish.dtuapp.module.fragment.FmtHistoryMultiYanshi;
//import com.minorfish.dtuapp.module.fragment.FmtLog;
//import com.minorfish.dtuapp.module.fragment.FmtModifyPwd;
//import com.minorfish.dtuapp.module.fragment.FmtRealDataThree;
...
//            FmtRealDataThree fmt = new FmtRealDataThree();
//            mFragments.put(R.id.rb_real_data, fmt);
//            ft.replace(R.id.fragment_container, fmt, FmtRealDataThree.class.getName());
//            ft.commit();
...
//                        if (needAdd) {
//                            fmt = new FmtRealDataThree();
//                            ft.add(R.id.fragment_container, fmt, FmtRealDataThree.class.getName());
//                        }
////                        try {
...
//                        if (needAdd) {
//                            fmt = new FmtHistoryMultiYanshi();
//                            ft.add(R.id.fragment_container, fmt, FmtHistoryMultiYanshi.class.getName());
//                        }
//                        break;
...
//                            try {
//                                ((FmtRealDataThree) mFragments.get(R.id.rb_real_data)).setRadio(tabName2,1);
//                            } catch (Exception e) {
//                                e.printStackTrace();
//                            }
//                        }else if(DeviceMonitorEnum.MONITOR_WATER_DRINK.getCode().equals(bean.mEstimateType.code)){
//                            Device mDevice = new Device(bean.mSerialPort, "9600");
...
//                    try {
//                        ((FmtRealDataThree) mFragments.get(R.id.rb_real_data)).showData(data,0);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//
...
//
//                    try {
//                        ((FmtRealDataThree) mFragments.get(R.id.rb_real_data)).showData(data2,1);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//
...
//        try {
//            ((FmtRealDataThree) mFragments.get(R.id.rb_real_data)).showData(data,2);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//        if(mSerialPortManagerMulti!=null) { //水质  06 03 00 01 00 08 14 7B
...
//        }
//        if(mSerialPortManagerMulti2!=null) { //环境
