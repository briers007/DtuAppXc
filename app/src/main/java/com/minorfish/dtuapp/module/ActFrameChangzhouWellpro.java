...
//
///**
// * Author: 485串口版（多个监测站支持）常州六参饮用水，新的转换器
// * Date: 2018/7/11
// */
...
//
//            final float toc = (tocInt * 0.004884f -4f) *(40.89f/16f);
...
//            if (buffer[i] == 0x01 && buffer[i + 1] == 0x03 && buffer[i + 2] == 0x10) {
...
//            mSerialPortManagerMultiUrea.sendCommand(new byte[]{0x01, 0x03, 0x00, 0x00, 0x00, 0x08, (byte) 0x44, (byte) 0x0C});
//        }
//
//        //心跳，本机状态
//        try {
