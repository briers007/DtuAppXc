...
/**
 * Author: 485串口版（多个监测站支持）昆山国宏仪器四参和尿素
 * Date: 2018/7/11
 */
public class ActFrame2guohong extends BaseActivity implements OnDatabaseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (App.getApp().getDtuSetting() != null) {
            ...
            ft.commit();
            dicMap = (HashMap<String, List<MonitorDicParameter.WarnLinesBean>>) FileKit.getObject(ActFrame2guohong.this, Constants.FILE_KEY_MONITOR_DIC);
...
//                        }
    ...
    public void backToFmtSensorSetting(boolean isAdd,int index) {
        ...
        if(isAdd) {
            try {
                sensorMap = (HashMap<String, String>) FileKit.getObject(ActFrame2guohong.this, Constants.FILE_KEY_SENSOR_DIC);//更新传感器列表
            }catch (Exception e){}
            try {
                //添加成功后打开串口
                //openOrSwitchPort();
...
//                        }, null);
    ...
    private OnGetSinglePacketListener mListener = new OnGetSinglePacketListener() {
        ...
        public synchronized void onGetSinglePacket(final byte[] singlePacket) {
            ...
            final float yulv = byte2floatCDAB(singlePacket, 15+18);
            final float temperature = byte2floatCDAB(singlePacket, 19+18);
            final float zhuodu = byte2floatCDAB(singlePacket, 23+18);
            ...
            mIOHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    TriggerBean phBean = handleData(DeviceMonitorEnum.MONITOR_WATER_SWIM_PH, ph);
    ...
    private void initDevice() {
        ...
        FileKit.save(ActFrame2guohong.this, mDeviceList, Constants.FILE_KEY_485_DEVICE);
        openDevice();
    }
            ...
            public void onResponse(String data) {
                ...
                if (resp.canParse()) {
                    ...
                    if (list != null && list.size() != 0) {
                        ...
                        dicMap = map;
                        FileKit.save(ActFrame2guohong.this, map, Constants.FILE_KEY_MONITOR_DIC);
                    }
                } else {
