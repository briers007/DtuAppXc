...
/**
 * Author: 485串口版（多个监测站支持）重庆远感机器，泳池水五参，多个电导率
 * Date: 2018/7/11
 */
public class ActFrame2yuanganFive extends BaseActivity implements OnDatabaseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (App.getApp().getDtuSetting() != null) {
            ...
            ft.commit();
            dicMap = (HashMap<String, List<MonitorDicParameter.WarnLinesBean>>) FileKit.getObject(ActFrame2yuanganFive.this, Constants.FILE_KEY_MONITOR_DIC);
...
//                        }
    ...
    public void backToFmtSensorSetting(boolean isAdd,int index) {
        ...
        if(isAdd) {
            try {
                sensorMap = (HashMap<String, String>) FileKit.getObject(ActFrame2yuanganFive.this, Constants.FILE_KEY_SENSOR_DIC);//更新传感器列表
            }catch (Exception e){}
            try {
                //添加成功后打开串口
                //openOrSwitchPort();
...
//                        }, null);
    ...
    private void initDevice() {
        ...
        FileKit.save(ActFrame2yuanganFive.this, mDeviceList, Constants.FILE_KEY_485_DEVICE);
        openDevice();
    }
            ...
            public void onResponse(String data) {
                ...
                if (resp.canParse()) {
                    ...
                    if (list != null && list.size() != 0) {
                        ...
                        dicMap = map;
                        FileKit.save(ActFrame2yuanganFive.this, map, Constants.FILE_KEY_MONITOR_DIC);
                    }
                } else {
