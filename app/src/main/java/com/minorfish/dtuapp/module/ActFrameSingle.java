...
//
///**
// * Author: 485串口版（单个监测站支持）昆山国宏仪器四参
// * Date: 2018/7/11
// */
...
//    public String port1 = "";
//    public String port2 = "";
//    private String sensorTypeCode = DeviceMonitorEnum.MONITOR_WATER_SWIM.getCode();
//
...
//            FmtRealDataChangzhou fmt = FmtRealDataChangzhou.newInstance(1);
...
//                        if (needAdd) {
//                            fmt = FmtRealDataChangzhou.newInstance(1);
...
//                        if (DeviceMonitorEnum.MONITOR_WATER_SWIM.getCode().equals(bean.mEstimateType.code)
//                                ||DeviceMonitorEnum.MONITOR_WATER_DRINK.getCode().equals(bean.mEstimateType.code) ) { //水质
//                            sensorTypeCode = bean.mEstimateType.code;
...
//                    }
//
//                    if (DeviceMonitorEnum.MONITOR_WATER_SWIM.getCode().equals(sensorTypeCode)) { //泳池水
...
//        if(mSerialPortManagerMulti!=null) {
//            mSerialPortManagerMulti.sendCommand(new byte[]{0x01, 0x03, 0x00, 0x10, 0x00, 0x10, 0x45, (byte) 0xC3});
//        }
//    }
//
