...
////            @Overridez
////            public void run() {
////                Intent intent = getPackageManager().getLaunchIntentForPackage("com.oray.sunlogin.service");
////                if (intent != null) {
...
//            final float zhuodu = byte2floatCDAB(singlePacket, 15);
//            final float temperature = byte2floatCDAB(singlePacket, 19);
//            final float yulv = byte2floatCDAB(singlePacket, 23);
//
...
//        //cod   010300 000002
//        if(mSerialPortManagerMultiCod!=null){
//            mSerialPortManagerMultiCod.sendCommand(new byte[]{0x01, 0x03, 0x00, 0x00, 0x00, 0x02, (byte) 0xC4, (byte) 0x0B});
//            //mSerialPortManagerMultiCod.sendCommand(new byte[]{0x01, 0x04, 0x00, 0x00, (byte)0x00, 0x02, (byte) 0x71, (byte) 0xCB});
//        }
//
//        //心跳，本机状态
//        try {
...
//    }
//
//    public int currentUreaCod = 1;//0尿素，1cod
