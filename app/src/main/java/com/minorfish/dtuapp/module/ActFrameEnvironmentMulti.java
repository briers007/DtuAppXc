...
//            parsePacket(buffer,(byte)0x01, mListener);
//        }
//    };
//
...
//        @Override
//        public void OnGetData485(byte[] buffer) {
//            parsePacket(buffer,(byte)0x01, mListener2);
//        }
//    };
//
//    private synchronized void parsePacket(byte[] buffer,byte one, OnGetSinglePacketListener listener) {
...
//            if (buffer[i] == one && buffer[i + 1] == 0x03 && buffer[i + 2] == (byte)0x0E) {
