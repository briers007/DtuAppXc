 ...
 * Date: 2018/7/11
 */
public class RvHistoryFive extends RvBase<RealDataHistoryBean> {
    public RvHistoryFive(Context context) {
        this(context, null);
    }

    public RvHistoryFive(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RvHistoryFive(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public int customSetItemLayoutId() {
        return R.layout.rv_item_history_data_yanshi_layout;
    }
