 ...
 * Date: 2018/7/11
 */
public class RvHistoryChangzhou extends RvBase<ChangzhouDataHistoryBean> {

    public RvHistoryChangzhou(Context context) {
        this(context, null);
    }

    public RvHistoryChangzhou(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RvHistoryChangzhou(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public int customSetItemLayoutId() {
        return R.layout.rv_item_history_changzhou_layout;
    }

    @Override
    public void customConvert(BaseViewHolder holder, ChangzhouDataHistoryBean bean) {
        holder.setText(R.id.ph_value, bean.ph+"")
                ...
                .setText(R.id.toc_value, bean.toc+"")
                .setText(R.id.cond_value, bean.cond+"");
        ...
        if(bean.tocLevel==2){
            holder.setTextColor(R.id.toc_value, getContext().getResources().getColor(R.color.text_red));
            holder.setText(R.id.toc_deta, bean.tocDeta+"");
            if (bean.tocDeta > 0) {
                holder.setTextColor(R.id.toc_deta, getContext().getResources().getColor(R.color.text_ff4739));
            }else{
                holder.setTextColor(R.id.toc_deta, getContext().getResources().getColor(R.color.text_3bcfff));
            }
            holder.setVisible(R.id.toc_deta,true);
        } else if(bean.tocLevel==1) {
            holder.setTextColor(R.id.toc_value, getContext().getResources().getColor(R.color.text_yellow));
            holder.setVisible(R.id.toc_deta,false);
        } else {
            holder.setTextColor(R.id.toc_value, getContext().getResources().getColor(R.color.text_green));
            holder.setVisible(R.id.toc_deta,false);
        }

        if(bean.condLevel==2){
            holder.setTextColor(R.id.cond_value, getContext().getResources().getColor(R.color.text_red));
            holder.setText(R.id.cond_deta, bean.condDeta+"");
            if (bean.condDeta > 0) {
                holder.setTextColor(R.id.cond_deta, getContext().getResources().getColor(R.color.text_ff4739));
            }else{
                holder.setTextColor(R.id.cond_deta, getContext().getResources().getColor(R.color.text_3bcfff));
            }
            holder.setVisible(R.id.cond_deta,true);
        } else if(bean.condLevel==1) {
            holder.setTextColor(R.id.cond_value, getContext().getResources().getColor(R.color.text_yellow));
            holder.setVisible(R.id.cond_deta,false);
        } else {
            holder.setTextColor(R.id.cond_value, getContext().getResources().getColor(R.color.text_green));
            holder.setVisible(R.id.cond_deta,false);
        }
    }
}
