 ...
 * Date: 2018/7/11
 */
public class RvHistoryXuzhou extends RvBase<XuzhouDataHistoryBean> {

    public RvHistoryXuzhou(Context context) {
        this(context, null);
    }

    public RvHistoryXuzhou(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RvHistoryXuzhou(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public int customSetItemLayoutId() {
        return R.layout.rv_item_history_xuzhou_layout;
    }

    @Override
    public void customConvert(BaseViewHolder holder, XuzhouDataHistoryBean bean) {
        holder.setText(R.id.ph_value, bean.ph+"")
                ...
                .setText(R.id.toc_value, bean.cod+"");
        ...
        if(bean.codLevel==2){
            ...
            holder.setText(R.id.toc_deta, bean.codDeta+"");
            if (bean.codDeta > 0) {
