...
//import com.minorfish.dtuapp.module.fragment.FmtHistoryXuzhou;
...
//
///**
// * Author: 485串口版（多个监测站支持）徐州饮用水五参
// * Date: 2018/7/11
// */
//public class ActFrameXuzhouFive extends BaseActivity implements OnDatabaseListener {
//
...
//            ft.commit();
//            dicMap = (HashMap<String, List<MonitorDicParameter.WarnLinesBean>>) FileKit.getObject(ActFrameXuzhouFive.this, Constants.FILE_KEY_MONITOR_DIC);
...
//                        if (needAdd) {
//                            fmt = new FmtHistoryXuzhou();
//                            ft.add(R.id.fragment_container, fmt, FmtHistoryXuzhou.class.getName());
//                        }
//                        break;
...
//        if(isAdd) {
//            try {
//                sensorMap = (HashMap<String, String>) FileKit.getObject(ActFrameXuzhouFive.this, Constants.FILE_KEY_SENSOR_DIC);//更新传感器列表
//            }catch (Exception e){}
//            try {
//                //添加成功后打开串口
//                //openOrSwitchPort();
...
//
//            final float yulv = Utils.getFloat(singlePacket, 3);
//            final float zhuodu =  Utils.getFloat(singlePacket, 7);
//            final float cod =  Utils.getFloat(singlePacket, 11);
//            final float ph =  Utils.getFloat(singlePacket, 15);
//            final float temperature =  Utils.getFloat(singlePacket, 19);
//
...
//                    TriggerBean codBean = handleData(DeviceMonitorEnum.MONITOR_WATER_DRINK_COD, cod);
//
...
//                    data.put(DeviceMonitorEnum.MONITOR_WATER_DRINK_COD, codBean);
//
//                    try {
...
//
//                    // upload and save
//                    XuzhouDataHistoryBean bean = new XuzhouDataHistoryBean();
...
//                    bean.cod = codBean.value;
//                    bean.codDeta = codBean.deta;
//                    bean.codLevel = codBean.level;
//                    bean.date = ts;
//                    try {
//                        getHelper().getXuzhouDataHistoryDao().createOrUpdate(bean);
//                    } catch (Exception e) {
//                    }
//                    try {
...
//                        sensorData5.code = DeviceMonitorEnum.MONITOR_WATER_DRINK_COD.getCode();
//                        sensorData5.value = cod + "";
...
//            if (buffer[i] == 0x02 && buffer[i + 1] == 0x04 && buffer[i + 2] == (byte)0x14) {
//                correctPacketStartIndex = i;
//            }
//        }
//        // 01 03 0C 09 C4 1B 8F 1F 40 01 90 00 00 00 00 F7 5D
...
//        if(mSerialPortManagerMulti!=null) {
//            mSerialPortManagerMulti.sendCommand(new byte[]{0x02, 0x04, 0x00, 0x00, 0x00, 0x05, (byte) 0x30, (byte) 0x3A});
//        }
//
//        //心跳，本机状态
//        try {
...
//                        }
//                        dicMap = map;
//                        FileKit.save(ActFrameXuzhouFive.this, map, Constants.FILE_KEY_MONITOR_DIC);
//                    }
//                } else {
