...
//
///**
// * Author: 485串口版（多个监测站支持）南京陆恒四参和尿素
// * Date: 2018/7/11
// */
...
//                    }
//                }
//                if (mFragments.get(R.id.rb_history)!=null) {
...
//    private static final int PACKET_LENGTH = 17;
...
//            int phInt = Utils.byte2Int(singlePacket, 5);
//            int yulvInt = Utils.byte2Int(singlePacket, 7);
//            int zhuoduInt = Utils.byte2Int(singlePacket, 9);
//
//            final float temperature = (float)temperatureInt/100;
//            final float ph = (float)phInt/1000;
//            final float yulv = (float)yulvInt/1000;
//            final float zhuodu = (float)zhuoduInt/1000;
//
...
//            if (buffer[i] == 0x01 && buffer[i + 1] == 0x03 && buffer[i + 2] == (byte)0x0C) {
...
////            mDevice = new Device(App.getApp().getSensorSetting().mSerialPort, "9600");
////            openOrSwitchPort();
////        } else {
////            mDevice = new Device(mDevices[mDeviceIndex], "9600");
////        }
////        String dev = "/dev/ttyS2";
////        Device mDevice = new Device(dev, "9600");
////        openOrSwitchPort(mDevice,0);
//        openDevice();
//    }
//
