...
//import com.minorfish.dtuapp.module.fragment.FmtHistoryEnvironment;
...
//                        if (needAdd) {
//                            fmt = new FmtHistoryEnvironment();
//                            ft.add(R.id.fragment_container, fmt, FmtHistoryEnvironment.class.getName());
//                        }
//                        break;
...
//                        if (DeviceMonitorEnum.MONITOR_ENV.getCode().equals(bean.mEstimateType.code)) { //环境
...
//
//    //原來是 3 + 14 +2
//    private static final int PACKET_LENGTH = 19;
...
//            final float ch2o =  ch2oInt;
//            final float voc =  vocInt;
//
...
//                    data.put(DeviceMonitorEnum.MONITOR_ENV_TEMPERATURE, temperatureBean);
//                    data.put(DeviceMonitorEnum.MONITOR_ENV_HUMIDITY, humidityBean);
//                    data.put(DeviceMonitorEnum.MONITOR_ENV_PM25, pm25Bean);
//                    data.put(DeviceMonitorEnum.MONITOR_ENV_PM10, pm10Bean);
//                    data.put(DeviceMonitorEnum.MONITOR_ENV_CO2, co2Bean);
//                    data.put(DeviceMonitorEnum.MONITOR_ENV_CH2O, ch2oBean);
//                    data.put(DeviceMonitorEnum.MONITOR_ENV_VOC, vocBean);
//
//                    try {
...
//        if(mSerialPortManagerMulti!=null) {
//            mSerialPortManagerMulti.sendCommand(new byte[]{0x01, 0x03, 0x00, 0x0A, 0x00, 0x07, (byte) 0x24, (byte) 0x0A});
//        }
//
//        //心跳，本机状态
//        try {
...
//                if(bean.mEstimateType!=null) {
//                    if (DeviceMonitorEnum.MONITOR_ENV.getCode().equals(bean.mEstimateType.code)) { //水质
//                        Device mDevice = new Device(bean.mSerialPort, "9600");
//                        mSerialPortManagerMulti = new SerialPortManagerMulti();
//                        openOrSwitchPort(mDevice);
//                        port1 = bean.mSerialPort;
