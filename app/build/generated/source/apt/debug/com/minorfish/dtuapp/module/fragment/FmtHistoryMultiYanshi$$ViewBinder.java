...
public class FmtHistoryMultiYanshi$$ViewBinder<T extends com.minorfish.dtuapp.module.fragment.FmtHistoryMultiYanshi> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131231005, "field 'swimHead'");
    target.swimHead = finder.castView(view, 2131231005, "field 'swimHead'");
    view = finder.findRequiredView(source, 2131230787, "field 'codHead'");
    target.codHead = finder.castView(view, 2131230787, "field 'codHead'");
    view = finder.findRequiredView(source, 2131231064, "field 'ureaHead'");
    target.ureaHead = finder.castView(view, 2131231064, "field 'ureaHead'");
    ...
    view = finder.findRequiredView(source, 2131230954, "field 'rvHistoryUrea'");
    target.rvHistoryUrea = finder.castView(view, 2131230954, "field 'rvHistoryUrea'");
    view = finder.findRequiredView(source, 2131230953, "field 'rvHistoryEnv'");
    target.rvHistoryEnv = finder.castView(view, 2131230953, "field 'rvHistoryEnv'");
    view = finder.findRequiredView(source, 2131230981, "field 'sensorLayout'");
    target.sensorLayout = finder.castView(view, 2131230981, "field 'sensorLayout'");
    view = finder.findRequiredView(source, 2131230983, "field 'sensorText'");
    target.sensorText = finder.castView(view, 2131230983, "field 'sensorText'");
  ...
  @Override public void unbind(T target) {
    target.swimHead = null;
    target.codHead = null;
    target.ureaHead = null;
    target.rvHistory = null;
    target.rvHistoryUrea = null;
    target.rvHistoryEnv = null;
    target.sensorLayout = null;
    target.sensorText = null;
