...
public class FmtLog$$ViewBinder<T extends com.minorfish.dtuapp.module.fragment.FmtLog> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131230955, "field 'rvLog'");
    target.rvLog = finder.castView(view, 2131230955, "field 'rvLog'");
    ...
    view = finder.findRequiredView(source, 2131230899, "field 'typeLayout'");
    target.typeLayout = finder.castView(view, 2131230899, "field 'typeLayout'");
    view = finder.findRequiredView(source, 2131230898, "field 'typeText'");
    target.typeText = finder.castView(view, 2131230898, "field 'typeText'");
