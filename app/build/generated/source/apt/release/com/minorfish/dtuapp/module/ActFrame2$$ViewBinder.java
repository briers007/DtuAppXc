...
public class ActFrame2$$ViewBinder<T extends com.minorfish.dtuapp.module.ActFrame2> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131231021, "field 'textVersion'");
    target.textVersion = finder.castView(view, 2131231021, "field 'textVersion'");
  }
